...
#  ---------------------------------------------------------------------
#
# Declarations of the C++ shim which instantiates Marmot's templated general gradient
# enhanced hypoelastic material base class. Kept separate from _marmotmaterials.pxd so
# that the hypoelastic extension does not have to include the gradient enhanced Marmot
# headers.
...
cdef extern from "_gradientenhancedshim.h" namespace "EdelweissFE" nogil:

    cdef cppclass GradientEnhancedHypoElasticShim1 "EdelweissFE::GradientEnhancedHypoElasticShim1":
