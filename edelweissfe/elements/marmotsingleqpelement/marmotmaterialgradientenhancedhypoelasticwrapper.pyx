...
cdef class MarmotMaterialGradientEnhancedHypoElasticWrapper:
    ...
    def getNumberOfRequiredStateVars(self,):
        ...
        nRequiredStateVarsMaterial = self.marmotMaterialGradientEnhancedHypoElastic.getNumberOfRequiredStateVars()
        nRequiredStateVarsOverhead = 2 * self.nU + self.nU * self.nU
        return nRequiredStateVarsOverhead + nRequiredStateVarsMaterial
    ...
    def assignStateVars(self, stateVars):
        ...
        self.marmotMaterialGradientEnhancedHypoElastic.assignStateVars(
                &self.stateVarsMaterial[0],
