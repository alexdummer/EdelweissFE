...
cdef class MarmotElementWrapper:
    ...
    def __init__(self, elementType, elNumber):
        ...
        For the documentation of MarmotElements,
        please refer to `Marmot <https://github.com/MAteRialMOdelingToolbox/Marmot/>`_.
    ...
    def __cinit__(self, elementType, elNumber):
        ...
        try:
            self.marmotElement = MarmotElementFactory.createElement(
                    MarmotElementFactory.getElementCodeFromName(elementType.upper().encode("utf-8")),
                    self._elNumber)
        except IndexError:
